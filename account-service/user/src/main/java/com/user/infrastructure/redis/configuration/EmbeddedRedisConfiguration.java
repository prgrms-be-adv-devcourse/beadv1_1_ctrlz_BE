...
public class EmbeddedRedisConfiguration {
	...
	public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
		...
		cacheConfigurations.put(CacheType.VERIFICATION_CODE.name(), defaultConfig.entryTtl(Duration.ofMinutes(1)));
		cacheConfigurations.put(CacheType.VERIFICATION_BAN_ONE_DAY.name(), defaultConfig.entryTtl(Duration.ofDays(1)));
