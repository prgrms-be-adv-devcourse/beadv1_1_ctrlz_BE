package com.paymentservice.common.exception;
...
import com.paymentservice.payment.exception.PaymentException;
...
public class GlobalExceptionHandler {
    ...
    /**
     * PaymentException를 상속받는 모든 예외 처리
     */
    @ExceptionHandler(PaymentException.class)
    public ResponseEntity<ErrorResponse> handleReviewException(PaymentException e) {
        e.printStackTrace();
